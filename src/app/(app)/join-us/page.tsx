...
import { Rocket, Users, Globe, Award, Sparkles, CheckCircle2 } from "lucide-react";
...
const perks = [
  {
    ...
    description: "Build high-altitude balloons, CubeSats, rovers, and astronomy research instruments.",
  },
  {
    icon: <Globe className="size-6 text-primary" />,
    title: "Global SEDS Network",
    description: "Connect directly with over 100+ international chapters and SEDS Earth conferences.",
  },
  {
    icon: <Award className="size-6 text-primary" />,
    title: "Competitions & Hackathons",
    description: "Participate in global space competitions, design challenges, and hackathons.",
  },
  {
    icon: <Users className="size-6 text-primary" />,
    title: "Mentorship & Career Growth",
    description: "Learn directly from aerospace engineers, astrophysicists, and industry mentors.",
  },
];
      ...
      <div className="grid-container section-content">
        <div className="col-span-4 md:col-span-8 lg:col-span-12">
          ...
          <SectionHeader
            ...
            description={
              <>
                Become part of Sri Lanka's largest student-driven space exploration and research organization. Apply below to shape the future of space technology.
              </>
            }
            ...
            <div className="lg:col-span-5 space-y-8">
                ...
                <div className="border border-border/60 divide-y divide-border/60 bg-background relative z-0">
                  <div className="p-6 bg-background space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Whether you are an engineer, designer, researcher, or space enthusiast, SEDS Sri Lanka provides the platform to turn passion into real-world impact.
                    </p>
                  </div>

                  {perks.map((perk, idx) => (
                    <div key={idx} className="p-5 bg-background flex items-start gap-4">
                      <div className="p-2.5 bg-primary/10 border border-primary/20 shrink-0">
                        {perk.icon}
                      </div>
                      <div className="space-y-1">
                        <h3 className="font-bold text-base text-foreground">{perk.title}</h3>
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-3 divide-x divide-border/60 border border-border/60 bg-background relative z-0">
                  {stats.map((st, idx) => (
                    <div key={idx} className="p-4 text-center space-y-1 bg-background">
                      <div className="text-2xl md:text-3xl font-bold font-mono text-primary">{st.value}</div>
                      <div className="text-[11px] uppercase tracking-wider font-mono text-muted-foreground">{st.label}</div>
                    </div>
                  ))}
                </div>
              </div>
