...
export const MediumImpactHero: React.FC<Page["hero"]> = ({
  ...
  return (
    <div className="relative w-full min-h-[300px] md:min-h-[400px] lg:min-h-[500px] overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col items-center justify-center text-center p-4 md:p-6 lg:p-8 min-h-[300px] md:min-h-[400px] lg:min-h-[500px] w-full text-foreground">
