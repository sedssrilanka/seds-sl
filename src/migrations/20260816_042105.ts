...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_projects_hero_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_projects_hero_links_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TYPE "public"."enum_projects_blocks_archive_relation_to" AS ENUM('products');
  CREATE TYPE "public"."enum_projects_blocks_carousel_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_projects_blocks_carousel_relation_to" AS ENUM('products');
  CREATE TYPE "public"."enum_projects_blocks_banner_style" AS ENUM('info', 'warning', 'error', 'success');
  CREATE TYPE "public"."enum_projects_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum_projects_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__projects_v_version_hero_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__projects_v_version_hero_links_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TYPE "public"."enum__projects_v_blocks_archive_relation_to" AS ENUM('products');
  CREATE TYPE "public"."enum__projects_v_blocks_carousel_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__projects_v_blocks_carousel_relation_to" AS ENUM('products');
  CREATE TYPE "public"."enum__projects_v_blocks_banner_style" AS ENUM('info', 'warning', 'error', 'success');
  CREATE TYPE "public"."enum__projects_v_version_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum__projects_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_chapters_social_links_platform" AS ENUM('facebook', 'twitter', 'instagram', 'linkedin');
  ...
  CREATE TYPE "public"."enum_divisions_hero_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_divisions_hero_links_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_divisions_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum_addresses_country" AS ENUM('LK', 'US', 'GB', 'CA', 'AU', 'AT', 'BE', 'BR', 'BG', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'DE', 'GR', 'HK', 'HU', 'IN', 'IE', 'IT', 'JP', 'LV', 'LT', 'LU', 'MY', 'MT', 'MX', 'NL', 'NZ', 'NO', 'PL', 'PT', 'RO', 'SG', 'SK', 'SI', 'ES', 'SE', 'CH');
  ...
  CREATE TYPE "public"."enum_carts_currency" AS ENUM('LKR', 'USD');
  CREATE TYPE "public"."enum_orders_status" AS ENUM('pending', 'processing', 'completed', 'cancelled', 'refunded');
  CREATE TYPE "public"."enum_orders_currency" AS ENUM('LKR', 'USD');
  CREATE TYPE "public"."enum_orders_payment_method" AS ENUM('bank_transfer', 'cod');
  CREATE TYPE "public"."enum_transactions_status" AS ENUM('pending', 'succeeded', 'failed', 'cancelled', 'expired', 'refunded');
  CREATE TYPE "public"."enum_transactions_currency" AS ENUM('LKR', 'USD');
  ...
  CREATE TABLE "projects_blocks_archive" (
  	...
  	"relation_to" "enum_projects_blocks_archive_relation_to" DEFAULT 'products',
  ...
  CREATE TABLE "projects_blocks_carousel" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"populate_by" "enum_projects_blocks_carousel_populate_by" DEFAULT 'collection',
  	"relation_to" "enum_projects_blocks_carousel_relation_to" DEFAULT 'products',
  	"limit" numeric DEFAULT 10,
  	"populated_docs_total" numeric,
  	"block_name" varchar
  );
  
  CREATE TABLE "projects_blocks_three_item_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "projects_blocks_banner" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"style" "enum_projects_blocks_banner_style" DEFAULT 'info',
  	"content" jsonb,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_projects_v_blocks_archive" (
  	...
  	"relation_to" "enum__projects_v_blocks_archive_relation_to" DEFAULT 'products',
  	"limit" numeric DEFAULT 10,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_projects_v_blocks_carousel" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"populate_by" "enum__projects_v_blocks_carousel_populate_by" DEFAULT 'collection',
  	"relation_to" "enum__projects_v_blocks_carousel_relation_to" DEFAULT 'products',
  	"limit" numeric DEFAULT 10,
  	"populated_docs_total" numeric,
  	"_uuid" varchar,
  	"block_name" varchar
  ...
  CREATE TABLE "_projects_v_blocks_three_item_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_projects_v_blocks_banner" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"style" "enum__projects_v_blocks_banner_style" DEFAULT 'info',
  	"content" jsonb,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "chapters_social_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"platform" "enum_chapters_social_links_platform" NOT NULL,
  ...
  CREATE TABLE "divisions_hero_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_divisions_hero_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL,
  	"link_appearance" "enum_divisions_hero_links_link_appearance" DEFAULT 'default'
  );
  ...
  CREATE TABLE "divisions" (
  	...
  	"hero_type" "enum_divisions_hero_type" DEFAULT 'lowImpact' NOT NULL,
  	"hero_rich_text" jsonb,
  	"hero_media_id" integer,
  	"description" varchar NOT NULL,
  	"content" jsonb NOT NULL,
  ...
  CREATE TABLE "variants" (
  	...
  	"price_in_l_k_r_enabled" boolean,
  	"price_in_l_k_r" numeric,
  ...
  CREATE TABLE "_variants_v" (
  	...
  	"version_price_in_l_k_r_enabled" boolean,
  	"version_price_in_l_k_r" numeric,
  ...
  CREATE TABLE "carts" (
  	...
  	"subtotal" numeric,
  	"currency" "enum_carts_currency" DEFAULT 'LKR',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "orders" (
  	...
  	"amount" numeric,
  	"currency" "enum_orders_currency" DEFAULT 'LKR',
  	"payment_method" "enum_orders_payment_method" DEFAULT 'bank_transfer',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "transactions" (
  	...
  	"cart_id" integer,
  	"amount" numeric,
  	"currency" "enum_transactions_currency" DEFAULT 'LKR',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "projects_blocks_three_item_grid" ADD CONSTRAINT "projects_blocks_three_item_grid_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "projects_blocks_banner" ADD CONSTRAINT "projects_blocks_banner_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "projects" ADD CONSTRAINT "projects_chapter_id_chapters_id_fk" FOREIGN KEY ("chapter_id") REFERENCES "public"."chapters"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_projects_v_blocks_carousel" ADD CONSTRAINT "_projects_v_blocks_carousel_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_projects_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_projects_v_blocks_three_item_grid" ADD CONSTRAINT "_projects_v_blocks_three_item_grid_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_projects_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_projects_v_blocks_banner" ADD CONSTRAINT "_projects_v_blocks_banner_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_projects_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_projects_v" ADD CONSTRAINT "_projects_v_version_chapter_id_chapters_id_fk" FOREIGN KEY ("version_chapter_id") REFERENCES "public"."chapters"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "chapters_gallery" ADD CONSTRAINT "chapters_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "chapters_gallery" ADD CONSTRAINT "chapters_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."chapters"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "chapters_social_links" ADD CONSTRAINT "chapters_social_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."chapters"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "chapters" ADD CONSTRAINT "chapters_logo_dark_id_media_id_fk" FOREIGN KEY ("logo_dark_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "chapters" ADD CONSTRAINT "chapters_logo_light_id_media_id_fk" FOREIGN KEY ("logo_light_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "chapters" ADD CONSTRAINT "chapters_main_image_id_media_id_fk" FOREIGN KEY ("main_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "divisions_hero_links" ADD CONSTRAINT "divisions_hero_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."divisions"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "divisions" ADD CONSTRAINT "divisions_hero_media_id_media_id_fk" FOREIGN KEY ("hero_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "divisions_rels" ADD CONSTRAINT "divisions_rels_pages_fk" FOREIGN KEY ("pages_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "projects_blocks_three_item_grid_order_idx" ON "projects_blocks_three_item_grid" USING btree ("_order");
  CREATE INDEX "projects_blocks_three_item_grid_parent_id_idx" ON "projects_blocks_three_item_grid" USING btree ("_parent_id");
  CREATE INDEX "projects_blocks_three_item_grid_path_idx" ON "projects_blocks_three_item_grid" USING btree ("_path");
  CREATE INDEX "projects_blocks_banner_order_idx" ON "projects_blocks_banner" USING btree ("_order");
  CREATE INDEX "projects_blocks_banner_parent_id_idx" ON "projects_blocks_banner" USING btree ("_parent_id");
  CREATE INDEX "projects_blocks_banner_path_idx" ON "projects_blocks_banner" USING btree ("_path");
  ...
  CREATE INDEX "projects_chapter_idx" ON "projects" USING btree ("chapter_id");
  ...
  CREATE INDEX "_projects_v_blocks_carousel_order_idx" ON "_projects_v_blocks_carousel" USING btree ("_order");
  CREATE INDEX "_projects_v_blocks_carousel_parent_id_idx" ON "_projects_v_blocks_carousel" USING btree ("_parent_id");
  CREATE INDEX "_projects_v_blocks_carousel_path_idx" ON "_projects_v_blocks_carousel" USING btree ("_path");
  CREATE INDEX "_projects_v_blocks_three_item_grid_order_idx" ON "_projects_v_blocks_three_item_grid" USING btree ("_order");
  CREATE INDEX "_projects_v_blocks_three_item_grid_parent_id_idx" ON "_projects_v_blocks_three_item_grid" USING btree ("_parent_id");
  CREATE INDEX "_projects_v_blocks_three_item_grid_path_idx" ON "_projects_v_blocks_three_item_grid" USING btree ("_path");
  CREATE INDEX "_projects_v_blocks_banner_order_idx" ON "_projects_v_blocks_banner" USING btree ("_order");
  CREATE INDEX "_projects_v_blocks_banner_parent_id_idx" ON "_projects_v_blocks_banner" USING btree ("_parent_id");
  CREATE INDEX "_projects_v_blocks_banner_path_idx" ON "_projects_v_blocks_banner" USING btree ("_path");
  ...
  CREATE INDEX "_projects_v_version_version_chapter_idx" ON "_projects_v" USING btree ("version_chapter_id");
  ...
  CREATE INDEX "chapters_gallery_order_idx" ON "chapters_gallery" USING btree ("_order");
  CREATE INDEX "chapters_gallery_parent_id_idx" ON "chapters_gallery" USING btree ("_parent_id");
  CREATE INDEX "chapters_gallery_image_idx" ON "chapters_gallery" USING btree ("image_id");
  CREATE INDEX "chapters_social_links_order_idx" ON "chapters_social_links" USING btree ("_order");
  CREATE INDEX "chapters_social_links_parent_id_idx" ON "chapters_social_links" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "chapters_slug_idx" ON "chapters" USING btree ("slug");
  CREATE INDEX "chapters_logo_dark_idx" ON "chapters" USING btree ("logo_dark_id");
  CREATE INDEX "chapters_logo_light_idx" ON "chapters" USING btree ("logo_light_id");
  CREATE INDEX "chapters_main_image_idx" ON "chapters" USING btree ("main_image_id");
  ...
  CREATE INDEX "divisions_hero_links_order_idx" ON "divisions_hero_links" USING btree ("_order");
  CREATE INDEX "divisions_hero_links_parent_id_idx" ON "divisions_hero_links" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "divisions_slug_idx" ON "divisions" USING btree ("slug");
  CREATE INDEX "divisions_hero_hero_media_idx" ON "divisions" USING btree ("hero_media_id");
  ...
  CREATE INDEX "divisions_rels_order_idx" ON "divisions_rels" USING btree ("order");
  CREATE INDEX "divisions_rels_parent_idx" ON "divisions_rels" USING btree ("parent_id");
  CREATE INDEX "divisions_rels_path_idx" ON "divisions_rels" USING btree ("path");
  CREATE INDEX "divisions_rels_pages_id_idx" ON "divisions_rels" USING btree ("pages_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "projects_blocks_three_item_grid" CASCADE;
  DROP TABLE "projects_blocks_banner" CASCADE;
  ...
  DROP TABLE "_projects_v_blocks_carousel" CASCADE;
  DROP TABLE "_projects_v_blocks_three_item_grid" CASCADE;
  DROP TABLE "_projects_v_blocks_banner" CASCADE;
  DROP TABLE "_projects_v_blocks_form_block" CASCADE;
  DROP TABLE "_projects_v" CASCADE;
  DROP TABLE "_projects_v_rels" CASCADE;
  DROP TABLE "chapters_gallery" CASCADE;
  DROP TABLE "chapters_social_links" CASCADE;
  ...
  DROP TABLE "divisions_hero_links" CASCADE;
  ...
  DROP TYPE "public"."enum_projects_blocks_carousel_populate_by";
  DROP TYPE "public"."enum_projects_blocks_carousel_relation_to";
  DROP TYPE "public"."enum_projects_blocks_banner_style";
  ...
  DROP TYPE "public"."enum__projects_v_blocks_carousel_populate_by";
  DROP TYPE "public"."enum__projects_v_blocks_carousel_relation_to";
  DROP TYPE "public"."enum__projects_v_blocks_banner_style";
  DROP TYPE "public"."enum__projects_v_version_hero_type";
  DROP TYPE "public"."enum__projects_v_version_status";
  DROP TYPE "public"."enum_chapters_social_links_platform";
  ...
  DROP TYPE "public"."enum_divisions_hero_links_link_type";
  DROP TYPE "public"."enum_divisions_hero_links_link_appearance";
  DROP TYPE "public"."enum_divisions_hero_type";
