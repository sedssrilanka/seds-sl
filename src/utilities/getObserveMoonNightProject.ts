...
export async function getObserveMoonNightProject(
  ...
  return {
    ...
    year,
    shortDescription:
      "Annual global celebration of lunar science and exploration with SEDS Sri Lanka.",
    description:
      "Join telescopes across Sri Lanka to view the craters, maria, and mountains of the Moon.",
    ...
    locations: [
      {
        id: "colombo",
        name: "Colombo - Galle Face Green",
        address: "Galle Face, Colombo 03",
        isMainLocation: true,
      },
      {
        id: "kandy",
        name: "Kandy - University of Peradeniya",
        address: "Peradeniya, Kandy",
      },
      {
        id: "moratuwa",
        name: "Moratuwa - University of Moratuwa",
