...
export const NASA_SPACE_APPS_EDITIONS: Record<string, SpaceAppsEdition> = {
  "2025": {
    ...
    tagline: "The concluding grand edition of NASA Space Apps Challenge organized across Sri Lanka by SEDS Sri Lanka.",
    ...
    nominees: [
      {
        ...
        description: "An open web intelligence engine transforming raw multi-spectral satellite imagery into interactive agricultural drought forecasts.",
        award: "National Winner & Global Nominee",
        university: "University of Moratuwa"
      },
      {
        teamName: "HelioWatch Ceylon",
        projectName: "SolarStorm AI: Real-Time Geomagnetic Disturbance Predictor",
        category: "Galactic Impact",
        description: "A machine learning pipeline forecasting geomagnetic disturbances using real-time NASA SDO solar telescope streams.",
      ...
      },
      {
        ...
        description: "A remote sensing model analyzing sea surface temperature anomalies and chlorophyll concentrations to assess coral bleaching risks.",
        award: "Global Nominee",
  ...
  "2024": {
    ...
    tagline: "Celebrating the solar maximum and harnessing solar, space science, and Earth observation open data.",
    ...
    nominees: [
      {
        ...
        category: "Best Use of Data",
        description: "An interactive mapping tool visualizing aurora probability and geomagnetic disruption risks using live ACE and DSCOVR satellite feeds.",
        award: "Global Nominee",
        university: "University of Moratuwa"
      },
      {
        ...
        category: "Local Impact",
        description: "Remote sensing analysis of Sri Lankan coastal mangrove health and blue carbon reserves using Landsat 9 and Sentinel-2 data.",
  ...
  "2023": {
    ...
    tagline: "Championing NASA's Year of Open Science with open-source tools, collaborative algorithms, and inclusive space education.",
    ...
    nominees: [
      {
        ...
        description: "Open-source orbital dynamics software calculating conjunction risks between low Earth orbit satellites.",
        award: "Global Nominee",
        university: "University of Peradeniya"
      },
      {
        ...
        category: "Galactic Impact",
        description: "Using NASA SMAP soil moisture data to provide localized irrigation advisories for Sri Lankan farmers.",
        award: "National Winner",
  ...
  "2022": {
    ...
    tagline: "Celebrating diversity, expanding access to aerospace frontiers, and building inclusive solutions.",
    ...
    nominees: [
      {
        ...
        category: "Local Impact",
        description: "Satellite vegetation index analysis identifying elephant corridor movements near agricultural boundaries.",
        award: "National Winner & Global Nominee",
        university: "University of Moratuwa"
      }
    ],
  ...
  "2021": {
    ...
    tagline: "Commemorating 10 years of global space hackathons with record virtual engagement across Sri Lanka.",
    ...
    nominees: [
      {
        ...
        category: "Best Use of Data",
        description: "Comparative atmospheric emissions analysis platform utilizing Sentinel-5P and NASA OCO-2 carbon satellite data.",
        award: "National Winner & Global Nominee",
        university: "University of Moratuwa"
      }
    ],
  ...
  "2020": {
    ...
    tagline: "Empowering young thinkers to take immediate action on climate change, pandemic response, and planetary health.",
    ...
    nominees: [
      {
        ...
        category: "Local Impact",
        description: "Integrating NASA GPM precipitation measurements with Sri Lankan hydrological models for river basin flood alerts.",
        award: "National Winner & Global Nominee",
        university: "University of Moratuwa"
      }
    ],
  ...
  "2019": {
    ...
    tagline: "The inaugural national edition facilitated under SEDS Sri Lanka leadership, establishing the country's flagship space hackathon tradition.",
    ...
    nominees: [
      {
        ...
        category: "Best Mission Concept",
        description: "A pathfinding simulation for small rovers navigating lunar polar permanently shadowed regions.",
        award: "National Winner & Global Nominee",
        university: "University of Moratuwa"
      }
    ],
